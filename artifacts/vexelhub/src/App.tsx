...
// Use the publishable key directly — no subdomain proxy needed on Replit
...
const clerkAppearance = {
  ...
  elements: {
    ...
    formFieldInput: "bg-input border-border focus:border-primary focus:ring-1 focus:ring-primary text-foreground placeholder:text-muted-foreground",
    footerAction: "mt-4",
    dividerLine: "bg-border",
    alert: "bg-destructive/10 border-destructive/20 text-destructive",
    otpCodeFieldInput: "bg-input border-border focus:border-primary text-foreground",
    formFieldRow: "mb-4",
    main: "p-8",
  },
};
